...
static SimEnumValUtils SSM_ST_SM1_values[] = {
    ...
    { "weiterfahren", SSM_st_weiterfahren_SM1},
    { "zurueckrollen", SSM_st_zurueckrollen_SM1},
    { "zurueckrollen", SSM_st_zurueckrollen_SM1},
};
const int SSM_ST_SM1_nb_values = 40;
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_fahren_haltenAmBerg_1_fahren_SM1", SSM_TR_fahren_haltenAmBerg_1_fahren_SM1},
    { "SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1", SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1},
    { "SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1", SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1},
    { "SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1", SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1},
    { "SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1", SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1},
    ...
    { "SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1", SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1},
    { "SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1", SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1},
    { "SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1", SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1},
};
const int SSM_TR_SM1_nb_values = 40;
