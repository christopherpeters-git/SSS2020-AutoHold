...
static SimEnumValUtils SSM_ST_SM1_values[] = {
    ...
    { "weiterfahren", SSM_st_weiterfahren_SM1},
    { "fahrzeugSteht", SSM_st_fahrzeugSteht_SM1},
    { "fahrzeugSteht", SSM_st_fahrzeugSteht_SM1},
};
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1", SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1},
    { "SSM_TR_fzg_Steht_HHVentil_gesperrt_fahrzeugSteht_1_fzg_Steht_HHVentil_gesperrt_SM1", SSM_TR_fzg_Steht_HHVentil_gesperrt_fahrzeugSteht_1_fzg_Steht_HHVentil_gesperrt_SM1},
    { "SSM_TR_fzg_Steht_HHVentil_gesperrt_fahrzeugSteht_1_fzg_Steht_HHVentil_gesperrt_SM1", SSM_TR_fzg_Steht_HHVentil_gesperrt_fahrzeugSteht_1_fzg_Steht_HHVentil_gesperrt_SM1},
    ...
    { "SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1", SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1},
    { "SSM_TR_fahrzeugSteht_erneutAnfahren_1_fahrzeugSteht_SM1", SSM_TR_fahrzeugSteht_erneutAnfahren_1_fahrzeugSteht_SM1},
    { "SSM_TR_fahrzeugSteht_erneutAnfahren_1_fahrzeugSteht_SM1", SSM_TR_fahrzeugSteht_erneutAnfahren_1_fahrzeugSteht_SM1},
};
