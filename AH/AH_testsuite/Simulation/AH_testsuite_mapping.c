...
const MappingEntry scope_1_entries[48] = {
    ...
    /* 47 */ { MAP_INSTANCE, "AH_testSuite_Pkg::divFahrer::autoModus_Notbremsung 1", NULL, sizeof(outC_autoModus_Notbremsung_AH_testSuite_Pkg_divFahrer), (size_t)&outputs_ctx.Context_autoModus_Notbremsung_1, NULL, NULL, NULL, &scope_81, 1, 47 }
};
