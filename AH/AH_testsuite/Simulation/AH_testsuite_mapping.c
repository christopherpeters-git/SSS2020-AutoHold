...
DECL_SCOPE(scope_101, 15);
DECL_SCOPE(scope_100, 1);
DECL_SCOPE(scope_99, 5);
DECL_SCOPE(scope_98, 1);
DECL_SCOPE(scope_97, 13);
DECL_SCOPE(scope_96, 1);
DECL_SCOPE(scope_95, 4);
DECL_SCOPE(scope_94, 1);
DECL_SCOPE(scope_93, 18);
DECL_SCOPE(scope_92, 1);
DECL_SCOPE(scope_91, 15);
DECL_SCOPE(scope_90, 1);
DECL_SCOPE(scope_89, 16);
DECL_SCOPE(scope_88, 1);
DECL_SCOPE(scope_87, 2);
DECL_SCOPE(scope_86, 1);
DECL_SCOPE(scope_85, 2);
DECL_SCOPE(scope_84, 1);
DECL_SCOPE(scope_83, 1);
DECL_SCOPE(scope_82, 27);
DECL_SCOPE(scope_81, 19);
...
DECL_SCOPE(scope_2, 44);
DECL_SCOPE(scope_1, 51);
...
static int isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_EPB_arretiert_und_HHVentil_frei_SM1; }
...
static int isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_fzg_Steht_HHVentil_gesperrt_SM1; }
static int isActive_SSM_ST_SM1_SSM_st_haltenAmBerg_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_haltenAmBerg_SM1; }
static int isActive_SSM_ST_SM1_SSM_st_parken_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_parken_SM1; }
static int isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_weiterfahren_SM1; }
...
static int isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1(void* pHandle) { return *(SSM_ST_SM1*)pHandle == SSM_st_zurueckrollen_SM1; }
...
static int isActive_SSM_TR_SM1_SSM_TR_EPB_arretiert_und_HHVentil_frei_anfahren_1_EPB_arretiert_und_HHVentil_frei_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_EPB_arretiert_und_HHVentil_frei_anfahren_1_EPB_arretiert_und_HHVentil_frei_SM1; }
...
static int isActive_SSM_TR_SM1_SSM_TR_anfahrenVorbereiten_EPB_arretiert_und_HHVentil_frei_1_anfahrenVorbereiten_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_anfahrenVorbereiten_EPB_arretiert_und_HHVentil_frei_1_anfahrenVorbereiten_SM1; }
...
static int isActive_SSM_TR_SM1_SSM_TR_erneutAnfahren_weiterfahren_1_erneutAnfahren_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_erneutAnfahren_weiterfahren_1_erneutAnfahren_SM1; }
static int isActive_SSM_TR_SM1_SSM_TR_fahren_haltenAmBerg_1_fahren_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_fahren_haltenAmBerg_1_fahren_SM1; }
...
static int isActive_SSM_TR_SM1_SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1; }
static int isActive_SSM_TR_SM1_SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1; }
static int isActive_SSM_TR_SM1_SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1; }
...
static int isActive_SSM_TR_SM1_SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1(void* pHandle) { return *(SSM_TR_SM1*)pHandle == SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1; }
...
const MappingEntry scope_139_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1, NULL, 1, 0 }
};
const MappingScope scope_139 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:zurueckrollen:<1",
    scope_139_entries, 1
};

const MappingEntry scope_138_entries[11] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_zurueckrollen_erneutAnfahren_1_zurueckrollen_SM1, &scope_139, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_zurueckrollen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_zurueckrollen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_zurueckrollen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_zurueckrollen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L1", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_zurueckrollen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L8", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_zurueckrollen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_zurueckrollen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L10", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_zurueckrollen_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L11", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_zurueckrollen_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 10", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_10), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, &scope_34, 1, 10 }
};
const MappingScope scope_138 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:zurueckrollen:",
    scope_138_entries, 11
};

const MappingEntry scope_137_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_137 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:weiterfahren:<1",
    scope_137_entries, 1
};

const MappingEntry scope_136_entries[8] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_weiterfahren_anhaltenZumBeenden_1_weiterfahren_SM1, &scope_137, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_weiterfahren_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_weiterfahren_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L4", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_weiterfahren_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L3", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_weiterfahren_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_weiterfahren_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_weiterfahren_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 9", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_9), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, &scope_34, 1, 7 }
};
const MappingScope scope_136 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:weiterfahren:",
    scope_136_entries, 8
};

const MappingEntry scope_135_entries[3] = {
    /* 0 */ { MAP_LOCAL, "_L1", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_EPB_angezogen_SM5_parken_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[18], isActive_SSM_ST_SM5_parken_SM1_SSM_st_EPB_angezogen_SM5_parken_SM1, NULL, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L2", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_EPB_angezogen_SM5_parken_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[18], isActive_SSM_ST_SM5_parken_SM1_SSM_st_EPB_angezogen_SM5_parken_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_EPB_angezogen_SM5_parken_SM1), &_Type_kcg_bool_Utils, &scope_81_entries[18], isActive_SSM_ST_SM5_parken_SM1_SSM_st_EPB_angezogen_SM5_parken_SM1, NULL, 1, 2 }
};
const MappingScope scope_135 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:EPB_angezogen:",
    scope_135_entries, 3
};

const MappingEntry scope_134_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_130_entries[6], isActive_SSM_TR_SM5_parken_SM1_SSM_TR_getriebeWahlhebelNach_P_EPB_angezogen_1_getriebeWahlhebelNach_P_SM5_parken_SM1, NULL, 1, 0 }
};
const MappingScope scope_134 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:getriebeWahlhebelNach_P:<1",
    scope_134_entries, 1
};

const MappingEntry scope_133_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_130_entries[6], isActive_SSM_TR_SM5_parken_SM1_SSM_TR_getriebeWahlhebelNach_P_EPB_angezogen_1_getriebeWahlhebelNach_P_SM5_parken_SM1, &scope_134, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_getriebeWahlhebelNach_P_SM5_parken_SM1), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[18], isActive_SSM_ST_SM5_parken_SM1_SSM_st_getriebeWahlhebelNach_P_SM5_parken_SM1, NULL, 1, 1 }
};
const MappingScope scope_133 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:getriebeWahlhebelNach_P:",
    scope_133_entries, 2
};

const MappingEntry scope_132_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_130_entries[6], isActive_SSM_TR_SM5_parken_SM1_SSM_TR_bremseDurchtreten_getriebeWahlhebelNach_P_1_bremseDurchtreten_SM5_parken_SM1, NULL, 1, 0 }
};
const MappingScope scope_132 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:bremseDurchtreten:<1",
    scope_132_entries, 1
};

const MappingEntry scope_131_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_130_entries[6], isActive_SSM_TR_SM5_parken_SM1_SSM_TR_bremseDurchtreten_getriebeWahlhebelNach_P_1_bremseDurchtreten_SM5_parken_SM1, &scope_132, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_bremseDurchtreten_SM5_parken_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[18], isActive_SSM_ST_SM5_parken_SM1_SSM_st_bremseDurchtreten_SM5_parken_SM1, NULL, 1, 1 }
};
const MappingScope scope_131 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:bremseDurchtreten:",
    scope_131_entries, 2
};

const MappingEntry scope_130_entries[10] = {
    /* 0 */ { MAP_LOCAL, "@active_state", NULL, sizeof(SSM_ST_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_state_act_parken_SM1), &_Type_SSM_ST_SM5_parken_SM1_Utils, NULL, NULL, NULL, 0, 0 },
    /* 1 */ { MAP_LOCAL, "@reset_active_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_reset_act_parken_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 1 },
    /* 2 */ { MAP_LOCAL, "@next_state", NULL, sizeof(SSM_ST_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_state_nxt_parken_SM1), &_Type_SSM_ST_SM5_parken_SM1_Utils, NULL, NULL, NULL, 0, 2 },
    /* 3 */ { MAP_LOCAL, "@reset_next_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_reset_nxt_parken_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 3 },
    /* 4 */ { MAP_LOCAL, "@selected_state", NULL, sizeof(SSM_ST_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_state_sel_parken_SM1), &_Type_SSM_ST_SM5_parken_SM1_Utils, NULL, NULL, NULL, 0, 4 },
    /* 5 */ { MAP_LOCAL, "@active_strong_transition", NULL, sizeof(SSM_TR_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_fired_strong_parken_SM1), &_Type_SSM_TR_SM5_parken_SM1_Utils, NULL, NULL, NULL, 0, 5 },
    /* 6 */ { MAP_LOCAL, "@active_weak_transition", NULL, sizeof(SSM_TR_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_fired_parken_SM1), &_Type_SSM_TR_SM5_parken_SM1_Utils, NULL, NULL, NULL, 0, 6 },
    /* 7 */ { MAP_STATE, "bremseDurchtreten:", NULL, 0, 0, NULL, &scope_130_entries[0], isActive_SSM_ST_SM5_parken_SM1_SSM_st_bremseDurchtreten_SM5_parken_SM1, &scope_131, 1, 7 },
    /* 8 */ { MAP_STATE, "getriebeWahlhebelNach_P:", NULL, 0, 0, NULL, &scope_130_entries[0], isActive_SSM_ST_SM5_parken_SM1_SSM_st_getriebeWahlhebelNach_P_SM5_parken_SM1, &scope_133, 1, 8 },
    /* 9 */ { MAP_STATE, "EPB_angezogen:", NULL, 0, 0, NULL, &scope_130_entries[0], isActive_SSM_ST_SM5_parken_SM1_SSM_st_EPB_angezogen_SM5_parken_SM1, &scope_135, 1, 9 }
};
const MappingScope scope_130 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:SM5:",
    scope_130_entries, 10
};

const MappingEntry scope_129_entries[1] = {
    /* 0 */ { MAP_AUTOMATON, "SM5:", NULL, 0, 0, NULL, NULL, NULL, &scope_130, 1, 0 }
};
const MappingScope scope_129 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:parken:",
    scope_129_entries, 1
};

const MappingEntry scope_128_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fzgSteht_parken_1_fzgSteht_SM1, NULL, 1, 0 }
};
const MappingScope scope_128 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fzgSteht:<1",
    scope_128_entries, 1
};

const MappingEntry scope_127_entries[25] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fzgSteht_parken_1_fzgSteht_SM1, &scope_128, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L2", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_fzgSteht_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L7", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_fzgSteht_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L6", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_fzgSteht_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L11", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_fzgSteht_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L41", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L41_fzgSteht_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L40", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L40_fzgSteht_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L38", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L38_fzgSteht_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L36", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L36_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L35", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L35_fzgSteht_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L34", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L34_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L32", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L32_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L42", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L42_fzgSteht_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L43", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L43_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L54", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L54_fzgSteht_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L55", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L55_fzgSteht_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L57", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L57_fzgSteht_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L58", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L58_fzgSteht_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_fzgSteht_SM1), &_Type_kcg_float64_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, NULL, 1, 23 },
    /* 24 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 8", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_8), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, &scope_34, 1, 24 }
};
const MappingScope scope_127 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fzgSteht:",
    scope_127_entries, 25
};

const MappingEntry scope_126_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_anhaltenZumBeenden_fzgSteht_1_anhaltenZumBeenden_SM1, NULL, 1, 0 }
};
const MappingScope scope_126 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anhaltenZumBeenden:<1",
    scope_126_entries, 1
};

const MappingEntry scope_125_entries[18] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_anhaltenZumBeenden_fzgSteht_1_anhaltenZumBeenden_SM1, &scope_126, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_anhaltenZumBeenden_SM1), &_Type_kcg_float64_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_anhaltenZumBeenden_SM1), &_Type_kcg_float64_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L12", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_anhaltenZumBeenden_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L13", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L13_anhaltenZumBeenden_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L14", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L15", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_anhaltenZumBeenden_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L16", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L16_anhaltenZumBeenden_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L17", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L17_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L18", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L18_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L19", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L19_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L20", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L20_anhaltenZumBeenden_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L21", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L21_anhaltenZumBeenden_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L22_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L23", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L23_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L24", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L24_anhaltenZumBeenden_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L25", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L25_anhaltenZumBeenden_SM1), &_Type_kcg_float64_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L26", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L26_anhaltenZumBeenden_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, NULL, 1, 17 }
};
const MappingScope scope_125 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anhaltenZumBeenden:",
    scope_125_entries, 18
};

const MappingEntry scope_124_entries[6] = {
    /* 0 */ { MAP_LOCAL, "_L2", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_gasGeben_SM2_erneutAnfahren_SM1), &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_gasGeben_SM2_erneutAnfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_gasGeben_SM2_erneutAnfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_gasGeben_SM2_erneutAnfahren_SM1), &_Type_kcg_bool_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_gasGeben_SM2_erneutAnfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L7", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_gasGeben_SM2_erneutAnfahren_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, NULL, 1, 5 }
};
const MappingScope scope_124 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:gasGeben:",
    scope_124_entries, 6
};

const MappingEntry scope_123_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_119_entries[6], isActive_SSM_TR_SM2_erneutAnfahren_SM1_SSM_TR_getriebe_auf_D_gasGeben_1_getriebe_auf_D_SM2_erneutAnfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_123 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:getriebe_auf_D:<1",
    scope_123_entries, 1
};

const MappingEntry scope_122_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_119_entries[6], isActive_SSM_TR_SM2_erneutAnfahren_SM1_SSM_TR_getriebe_auf_D_gasGeben_1_getriebe_auf_D_SM2_erneutAnfahren_SM1, &scope_123, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_getriebe_auf_D_SM2_erneutAnfahren_SM1), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_getriebe_auf_D_SM2_erneutAnfahren_SM1, NULL, 1, 1 }
};
const MappingScope scope_122 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:getriebe_auf_D:",
    scope_122_entries, 2
};

const MappingEntry scope_121_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_119_entries[6], isActive_SSM_TR_SM2_erneutAnfahren_SM1_SSM_TR_bremspedalTreten_getriebe_auf_D_1_bremspedalTreten_SM2_erneutAnfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_121 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:bremspedalTreten:<1",
    scope_121_entries, 1
};

const MappingEntry scope_120_entries[3] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_119_entries[6], isActive_SSM_TR_SM2_erneutAnfahren_SM1_SSM_TR_bremspedalTreten_getriebe_auf_D_1_bremspedalTreten_SM2_erneutAnfahren_SM1, &scope_121, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_bremspedalTreten_SM2_erneutAnfahren_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_bremspedalTreten_SM2_erneutAnfahren_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_bremspedalTreten_SM2_erneutAnfahren_SM1), &_Type_kcg_bool_Utils, &scope_81_entries[17], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_bremspedalTreten_SM2_erneutAnfahren_SM1, NULL, 1, 2 }
};
const MappingScope scope_120 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:bremspedalTreten:",
    scope_120_entries, 3
};

const MappingEntry scope_119_entries[10] = {
    /* 0 */ { MAP_LOCAL, "@active_state", NULL, sizeof(SSM_ST_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_act_erneutAnfahren_SM1), &_Type_SSM_ST_SM2_erneutAnfahren_SM1_Utils, NULL, NULL, NULL, 0, 0 },
    /* 1 */ { MAP_LOCAL, "@reset_active_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_reset_act_erneutAnfahren_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 1 },
    /* 2 */ { MAP_LOCAL, "@next_state", NULL, sizeof(SSM_ST_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_nxt_erneutAnfahren_SM1), &_Type_SSM_ST_SM2_erneutAnfahren_SM1_Utils, NULL, NULL, NULL, 0, 2 },
    /* 3 */ { MAP_LOCAL, "@reset_next_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_reset_nxt_erneutAnfahren_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 3 },
    /* 4 */ { MAP_LOCAL, "@selected_state", NULL, sizeof(SSM_ST_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_sel_erneutAnfahren_SM1), &_Type_SSM_ST_SM2_erneutAnfahren_SM1_Utils, NULL, NULL, NULL, 0, 4 },
    /* 5 */ { MAP_LOCAL, "@active_strong_transition", NULL, sizeof(SSM_TR_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_fired_strong_erneutAnfahren_SM1), &_Type_SSM_TR_SM2_erneutAnfahren_SM1_Utils, NULL, NULL, NULL, 0, 5 },
    /* 6 */ { MAP_LOCAL, "@active_weak_transition", NULL, sizeof(SSM_TR_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_fired_erneutAnfahren_SM1), &_Type_SSM_TR_SM2_erneutAnfahren_SM1_Utils, NULL, NULL, NULL, 0, 6 },
    /* 7 */ { MAP_STATE, "bremspedalTreten:", NULL, 0, 0, NULL, &scope_119_entries[0], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_bremspedalTreten_SM2_erneutAnfahren_SM1, &scope_120, 1, 7 },
    /* 8 */ { MAP_STATE, "getriebe_auf_D:", NULL, 0, 0, NULL, &scope_119_entries[0], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_getriebe_auf_D_SM2_erneutAnfahren_SM1, &scope_122, 1, 8 },
    /* 9 */ { MAP_STATE, "gasGeben:", NULL, 0, 0, NULL, &scope_119_entries[0], isActive_SSM_ST_SM2_erneutAnfahren_SM1_SSM_st_gasGeben_SM2_erneutAnfahren_SM1, &scope_124, 1, 9 }
};
const MappingScope scope_119 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:SM2:",
    scope_119_entries, 10
};

const MappingEntry scope_118_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_erneutAnfahren_weiterfahren_1_erneutAnfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_118 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:<1",
    scope_118_entries, 1
};

const MappingEntry scope_117_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_erneutAnfahren_weiterfahren_1_erneutAnfahren_SM1, &scope_118, 1, 0 },
    /* 1 */ { MAP_AUTOMATON, "SM2:", NULL, 0, 0, NULL, NULL, NULL, &scope_119, 1, 1 }
};
const MappingScope scope_117 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:erneutAnfahren:",
    scope_117_entries, 2
};

const MappingEntry scope_116_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 0 }
};
const MappingScope scope_116 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fzg_Steht_HHVentil_gesperrt:<1",
    scope_116_entries, 1
};

const MappingEntry scope_115_entries[18] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fzg_Steht_HHVentil_gesperrt_zurueckrollen_1_fzg_Steht_HHVentil_gesperrt_SM1, &scope_116, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L4", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L2", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L7", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L6", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L14", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L15", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L17", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L17_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L20_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L21", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L21_fzg_Steht_HHVentil_gesperrt_SM1), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, NULL, 1, 16 },
    /* 17 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 7", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_7), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, &scope_34, 1, 17 }
};
const MappingScope scope_115 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fzg_Steht_HHVentil_gesperrt:",
    scope_115_entries, 18
};

const MappingEntry scope_114_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1, NULL, 1, 0 }
};
const MappingScope scope_114 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:haltenAmBerg:<1",
    scope_114_entries, 1
};

const MappingEntry scope_113_entries[3] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_haltenAmBerg_fzg_Steht_HHVentil_gesperrt_1_haltenAmBerg_SM1, &scope_114, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_haltenAmBerg_SM1), &_Type_kcg_float64_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_haltenAmBerg_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L15", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_haltenAmBerg_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_haltenAmBerg_SM1, NULL, 1, 2 }
};
const MappingScope scope_113 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:haltenAmBerg:",
    scope_113_entries, 3
};

const MappingEntry scope_112_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fahren_haltenAmBerg_1_fahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_112 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fahren:<1",
    scope_112_entries, 1
};

const MappingEntry scope_111_entries[1] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_fahren_haltenAmBerg_1_fahren_SM1, &scope_112, 1, 0 }
};
const MappingScope scope_111 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:fahren:",
    scope_111_entries, 1
};

const MappingEntry scope_110_entries[6] = {
    /* 0 */ { MAP_LOCAL, "_L7", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_gasGeben_SM2_anfahren_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_gasGeben_SM2_anfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_gasGeben_SM2_anfahren_SM1), &_Type_kcg_bool_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_gasGeben_SM2_anfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_float64), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_gasGeben_SM2_anfahren_SM1), &_Type_kcg_float64_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L2", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_gasGeben_SM2_anfahren_SM1), &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_gasGeben_SM2_anfahren_SM1, NULL, 1, 5 }
};
const MappingScope scope_110 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:gasGeben:",
    scope_110_entries, 6
};

const MappingEntry scope_109_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_105_entries[6], isActive_SSM_TR_SM2_anfahren_SM1__12_SSM_TR_getriebe_auf_D_gasGeben_1_getriebe_auf_D_SM2_anfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_109 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:getriebe_auf_D:<1",
    scope_109_entries, 1
};

const MappingEntry scope_108_entries[2] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_105_entries[6], isActive_SSM_TR_SM2_anfahren_SM1__12_SSM_TR_getriebe_auf_D_gasGeben_1_getriebe_auf_D_SM2_anfahren_SM1, &scope_109, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_getriebe_auf_D_SM2_anfahren_SM1), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_getriebe_auf_D_SM2_anfahren_SM1, NULL, 1, 1 }
};
const MappingScope scope_108 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:getriebe_auf_D:",
    scope_108_entries, 2
};

const MappingEntry scope_107_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_105_entries[6], isActive_SSM_TR_SM2_anfahren_SM1__13_SSM_TR_bremspedalTreten_getriebe_auf_D_1_bremspedalTreten_SM2_anfahren_SM1, NULL, 1, 0 }
};
const MappingScope scope_107 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:bremspedalTreten:<1",
    scope_107_entries, 1
};

const MappingEntry scope_106_entries[3] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_105_entries[6], isActive_SSM_TR_SM2_anfahren_SM1__13_SSM_TR_bremspedalTreten_getriebe_auf_D_1_bremspedalTreten_SM2_anfahren_SM1, &scope_107, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_bremspedalTreten_SM2_anfahren_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_bremspedalTreten_SM2_anfahren_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_bremspedalTreten_SM2_anfahren_SM1), &_Type_kcg_bool_Utils, &scope_81_entries[15], isActive_SSM_ST_SM2_anfahren_SM1_SSM_st_bremspedalTreten_SM2_anfahren_SM1, NULL, 1, 2 }
};
const MappingScope scope_106 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:bremspedalTreten:",
    scope_106_entries, 3
};

const MappingEntry scope_105_entries[10] = {
    /* 0 */ { MAP_LOCAL, "@active_state", NULL, sizeof(SSM_ST_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_act_anfahren_SM1), &_Type_SSM_ST_SM2_anfahren_SM1_Utils, NULL, NULL, NULL, 0, 0 },
    /* 1 */ { MAP_LOCAL, "@reset_active_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_reset_act_anfahren_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 1 },
    /* 2 */ { MAP_LOCAL, "@next_state", NULL, sizeof(SSM_ST_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_nxt_anfahren_SM1), &_Type_SSM_ST_SM2_anfahren_SM1_Utils, NULL, NULL, NULL, 0, 2 },
    /* 3 */ { MAP_LOCAL, "@reset_next_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_reset_nxt_anfahren_SM1), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 3 },
    /* 4 */ { MAP_LOCAL, "@selected_state", NULL, sizeof(SSM_ST_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_state_sel_anfahren_SM1), &_Type_SSM_ST_SM2_anfahren_SM1_Utils, NULL, NULL, NULL, 0, 4 },
    /* 5 */ { MAP_LOCAL, "@active_strong_transition", NULL, sizeof(SSM_TR_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_fired_strong_anfahren_SM1), &_Type_SSM_TR_SM2_anfahren_SM1_Utils, NULL, NULL, NULL, 0, 5 },
    /* 6 */ { MAP_LOCAL, "@active_weak_transition", NULL, sizeof(SSM_TR_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_fired_anfahren_SM1), &_Type_SSM_TR_SM2_anfahren_SM1_Utils, NULL, NULL, NULL, 0, 6 },
...
const MappingScope scope_105 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:SM2:",
...
const MappingScope scope_104 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:<1",
    scope_104_entries, 1
};
...
const MappingScope scope_103 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahren:",
    scope_103_entries, 2
};

const MappingEntry scope_102_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_EPB_arretiert_und_HHVentil_frei_anfahren_1_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 0 }
};
const MappingScope scope_102 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:EPB_arretiert_und_HHVentil_frei:<1",
    scope_102_entries, 1
};

const MappingEntry scope_101_entries[15] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_EPB_arretiert_und_HHVentil_frei_anfahren_1_EPB_arretiert_und_HHVentil_frei_SM1, &scope_102, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L13_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L9", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L8", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L15", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L16", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L16_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L17", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L17_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L18", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L18_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L19", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L19_EPB_arretiert_und_HHVentil_frei_SM1), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 5", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_5), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, &scope_34, 1, 14 }
};
const MappingScope scope_101 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:EPB_arretiert_und_HHVentil_frei:",
    scope_101_entries, 15
};

const MappingEntry scope_100_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_anfahrenVorbereiten_EPB_arretiert_und_HHVentil_frei_1_anfahrenVorbereiten_SM1, NULL, 1, 0 }
};
const MappingScope scope_100 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahrenVorbereiten:<1",
    scope_100_entries, 1
};

const MappingEntry scope_99_entries[5] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_82_entries[6], isActive_SSM_TR_SM1_SSM_TR_anfahrenVorbereiten_EPB_arretiert_und_HHVentil_frei_1_anfahrenVorbereiten_SM1, &scope_100, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_anfahrenVorbereiten_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anfahrenVorbereiten_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L6", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_anfahrenVorbereiten_SM1), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anfahrenVorbereiten_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L7", NULL, sizeof(tuerSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_anfahrenVorbereiten_SM1), &_Type_tuerSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anfahrenVorbereiten_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L8", NULL, sizeof(sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_anfahrenVorbereiten_SM1), &_Type_sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anfahrenVorbereiten_SM1, NULL, 1, 4 }
};
const MappingScope scope_99 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:anfahrenVorbereiten:",
    scope_99_entries, 5
};
...
const MappingScope scope_98 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:EPB_angezogen:<1",
    scope_98_entries, 1
};
...
const MappingEntry scope_97_entries[13] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_EPB_angezogen_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_EPB_angezogen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L4", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_EPB_angezogen_SM1), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L6", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_EPB_angezogen_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L7", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_EPB_angezogen_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L13_EPB_angezogen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_EPB_angezogen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_EPB_angezogen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_EPB_angezogen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L9", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_EPB_angezogen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L8", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_EPB_angezogen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 4", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_4), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_angezogen_SM1, &scope_34, 1, 12 }
};
const MappingScope scope_97 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:EPB_angezogen:",
    scope_97_entries, 13
};
...
const MappingScope scope_96 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:betriebsbremseLoesen:<1",
    scope_96_entries, 1
};
...
const MappingEntry scope_95_entries[4] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_betriebsbremseLoesen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_betriebsbremseLoesen_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L5", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_betriebsbremseLoesen_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_betriebsbremseLoesen_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L6", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_betriebsbremseLoesen_SM1), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_betriebsbremseLoesen_SM1, NULL, 1, 3 }
};
const MappingScope scope_95 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:betriebsbremseLoesen:",
    scope_95_entries, 4
};
...
const MappingScope scope_94 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:cockpitanzeigeBleibtAus:<1",
    scope_94_entries, 1
};
...
const MappingEntry scope_93_entries[18] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_cockpitanzeigeBleibtAus_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L11", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_cockpitanzeigeBleibtAus_SM1), &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L9", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_cockpitanzeigeBleibtAus_SM1), &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L14", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14_cockpitanzeigeBleibtAus_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L16", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L16_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L21", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L21_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L22", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L22_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L20", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L20_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L19", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L19_cockpitanzeigeBleibtAus_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L18", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L18_cockpitanzeigeBleibtAus_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L23", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L23_cockpitanzeigeBleibtAus_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L25", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L25_cockpitanzeigeBleibtAus_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L26", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L26_cockpitanzeigeBleibtAus_SM1), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, NULL, 1, 16 },
    /* 17 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 3", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_3), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, &scope_34, 1, 17 }
};
const MappingScope scope_93 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:cockpitanzeigeBleibtAus:",
    scope_93_entries, 18
};
...
const MappingScope scope_92 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:automatikModusEingestellt:<1",
    scope_92_entries, 1
};
...
const MappingEntry scope_91_entries[15] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L2", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_automatikModusEingestellt_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L3_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L4", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_automatikModusEingestellt_SM1), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L9_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L8", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_automatikModusEingestellt_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L7", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_automatikModusEingestellt_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12_automatikModusEingestellt_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L14", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14_automatikModusEingestellt_SM1), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L15", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_automatikModusEingestellt_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 2", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_2), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, &scope_34, 1, 14 }
};
const MappingScope scope_91 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:automatikModusEingestellt:",
    scope_91_entries, 15
};
...
const MappingScope scope_90 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:automastikModusEinstellen:<1",
    scope_90_entries, 1
};
...
const MappingEntry scope_89_entries[16] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L5_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L4_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L6_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L7_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L8", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L8_automastikModusEinstellen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L10", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L10_automastikModusEinstellen_SM1), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L11", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L11_automastikModusEinstellen_SM1), &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L13", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L13_automastikModusEinstellen_SM1), &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L14", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L15", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L16", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L16_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L17", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L17_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L25", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L25_automastikModusEinstellen_SM1), &_Type_kcg_bool_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L26", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L26_automastikModusEinstellen_SM1), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, NULL, 1, 14 },
    /* 15 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::countDownTimer 1", NULL, sizeof(outC_countDownTimer_AhTypes_Pkg_utils_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, Context_countDownTimer_1), NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, &scope_34, 1, 15 }
};
const MappingScope scope_89 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:automastikModusEinstellen:",
    scope_89_entries, 16
};

const MappingEntry scope_88_entries[1] = {
...
const MappingScope scope_88 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:bremspedalDurchtreten:<1",
    scope_88_entries, 1
};
...
const MappingEntry scope_87_entries[2] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L2", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L2_bremspedalDurchtreten_SM1), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_bremspedalDurchtreten_SM1, NULL, 1, 1 }
};
const MappingScope scope_87 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:bremspedalDurchtreten:",
    scope_87_entries, 2
};
...
const MappingScope scope_86 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:zuendungEinschalten:<1",
    scope_86_entries, 1
};
...
const MappingEntry scope_85_entries[2] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L1_zuendungEinschalten_SM1), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zuendungEinschalten_SM1, NULL, 1, 1 }
};
const MappingScope scope_85 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:zuendungEinschalten:",
    scope_85_entries, 2
};
...
const MappingScope scope_84 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:Start:<1",
    scope_84_entries, 1
};
...
const MappingScope scope_83 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:Start:",
    scope_83_entries, 1
};

const MappingEntry scope_82_entries[27] = {
    /* 0 */ { MAP_LOCAL, "@active_state", NULL, sizeof(SSM_ST_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_state_act), &_Type_SSM_ST_SM1_Utils, NULL, NULL, NULL, 0, 0 },
    /* 1 */ { MAP_LOCAL, "@reset_active_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_reset_act), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 1 },
    /* 2 */ { MAP_LOCAL, "@next_state", NULL, sizeof(SSM_ST_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_state_nxt), &_Type_SSM_ST_SM1_Utils, NULL, NULL, NULL, 0, 2 },
    /* 3 */ { MAP_LOCAL, "@reset_next_state", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_reset_nxt), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 0, 3 },
    /* 4 */ { MAP_LOCAL, "@selected_state", NULL, sizeof(SSM_ST_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_state_sel), &_Type_SSM_ST_SM1_Utils, NULL, NULL, NULL, 0, 4 },
    /* 5 */ { MAP_LOCAL, "@active_strong_transition", NULL, sizeof(SSM_TR_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_fired_strong), &_Type_SSM_TR_SM1_Utils, NULL, NULL, NULL, 0, 5 },
    /* 6 */ { MAP_LOCAL, "@active_weak_transition", NULL, sizeof(SSM_TR_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_fired), &_Type_SSM_TR_SM1_Utils, NULL, NULL, NULL, 0, 6 },
    ...
    /* 10 */ { MAP_STATE, "automastikModusEinstellen:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automastikModusEinstellen_SM1, &scope_89, 1, 10 },
    /* 11 */ { MAP_STATE, "automatikModusEingestellt:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_automatikModusEingestellt_SM1, &scope_91, 1, 11 },
    /* 12 */ { MAP_STATE, "cockpitanzeigeBleibtAus:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_cockpitanzeigeBleibtAus_SM1, &scope_93, 1, 12 },
    /* 13 */ { MAP_STATE, "betriebsbremseLoesen:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_betriebsbremseLoesen_SM1, &scope_95, 1, 13 },
    ...
    /* 16 */ { MAP_STATE, "EPB_arretiert_und_HHVentil_frei:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_EPB_arretiert_und_HHVentil_frei_SM1, &scope_101, 1, 16 },
    ...
    /* 19 */ { MAP_STATE, "haltenAmBerg:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_haltenAmBerg_SM1, &scope_113, 1, 19 },
    /* 20 */ { MAP_STATE, "fzg_Steht_HHVentil_gesperrt:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzg_Steht_HHVentil_gesperrt_SM1, &scope_115, 1, 20 },
    /* 21 */ { MAP_STATE, "erneutAnfahren:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_erneutAnfahren_SM1, &scope_117, 1, 21 },
    /* 22 */ { MAP_STATE, "anhaltenZumBeenden:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_anhaltenZumBeenden_SM1, &scope_125, 1, 22 },
    /* 23 */ { MAP_STATE, "fzgSteht:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_fzgSteht_SM1, &scope_127, 1, 23 },
    /* 24 */ { MAP_STATE, "parken:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_parken_SM1, &scope_129, 1, 24 },
    /* 25 */ { MAP_STATE, "weiterfahren:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_weiterfahren_SM1, &scope_136, 1, 25 },
    /* 26 */ { MAP_STATE, "zurueckrollen:", NULL, 0, 0, NULL, &scope_82_entries[0], isActive_SSM_ST_SM1_SSM_st_zurueckrollen_SM1, &scope_138, 1, 26 }
};
const MappingScope scope_82 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrerSM1:",
    scope_82_entries, 27
};

const MappingEntry scope_81_entries[19] = {
    /* 0 */ { MAP_OUTPUT, "zuendschalter", NULL, sizeof(zuendSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, zuendschalter), &_Type_zuendSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 0 },
    /* 1 */ { MAP_OUTPUT, "getriebeWahlhebel", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, getriebeWahlhebel), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 1 },
    /* 2 */ { MAP_OUTPUT, "fahrertuerSchalter", NULL, sizeof(tuerSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, fahrertuerSchalter), &_Type_tuerSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_OUTPUT, "sicherheitsgurtSchalter", NULL, sizeof(sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, sicherheitsgurtSchalter), &_Type_sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_OUTPUT, "taste_P", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, taste_P), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_OUTPUT, "gaspedalStellung", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, gaspedalStellung), &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_OUTPUT, "error", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, error), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_OUTPUT, "bremspedalKraft", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, bremspedalKraft), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_OUTPUT, "taste_Hold", NULL, sizeof(tasterHold_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, taste_Hold), &_Type_tasterHold_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_LOCAL, "ready", NULL, sizeof(kcg_bool), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, ready), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L12", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L12), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L13", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L13), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L14", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L14), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L15", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, _L15), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_AUTOMATON, "SM1:", NULL, 0, 0, NULL, NULL, NULL, &scope_82, 1, 14 },
    /* 15 */ { MAP_LOCAL, "@kcg1", NULL, sizeof(SSM_ST_SM2_anfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_clock_anfahren_SM1), &_Type_SSM_ST_SM2_anfahren_SM1_Utils, &scope_81_entries[16], isActive_SSM_ST_SM1_SSM_st_anfahren_SM1, NULL, 0, 15 },
    /* 16 */ { MAP_LOCAL, "@kcg2", NULL, sizeof(SSM_ST_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM1_state_act), &_Type_SSM_ST_SM1_Utils, NULL, NULL, NULL, 0, 16 },
    /* 17 */ { MAP_LOCAL, "@kcg3", NULL, sizeof(SSM_ST_SM2_erneutAnfahren_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM2_clock_erneutAnfahren_SM1), &_Type_SSM_ST_SM2_erneutAnfahren_SM1_Utils, &scope_81_entries[16], isActive_SSM_ST_SM1_SSM_st_erneutAnfahren_SM1, NULL, 0, 17 },
    /* 18 */ { MAP_LOCAL, "@kcg4", NULL, sizeof(SSM_ST_SM5_parken_SM1), offsetof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer, SM5_clock_parken_SM1), &_Type_SSM_ST_SM5_parken_SM1_Utils, &scope_81_entries[16], isActive_SSM_ST_SM1_SSM_st_parken_SM1, NULL, 0, 18 }
};
const MappingScope scope_81 = {
    "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold/ autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer",
    scope_81_entries, 19
};

const MappingEntry scope_80_entries[4] = {
...
const MappingEntry scope_2_entries[44] = {
    ...
    /* 11 */ { MAP_OUTPUT, "betriebsbremsSperrventil", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, betriebsbremsSperrventil), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_LOCAL, "fzgLaengsneigung_loc", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, fzgLaengsneigung_loc), &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L1", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L1), &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L3", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L3), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L2", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L2), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L7", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L7), &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L18", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L18), &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L17", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L17), &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L16", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L16), &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L15", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L15), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L14", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L14), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L13", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L13), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L12", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L12), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L11", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L11), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L10", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L10), &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L19", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L19), &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L22", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L22), &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L24", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L24), &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L25", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L25), &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L26", NULL, sizeof(zuendSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L26), &_Type_zuendSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L27", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L27), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L28", NULL, sizeof(tuerSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L28), &_Type_tuerSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L29", NULL, sizeof(sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L29), &_Type_sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 33 },
    /* 34 */ { MAP_LOCAL, "_L30", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L30), &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 34 },
    /* 35 */ { MAP_LOCAL, "_L31", NULL, sizeof(tasterHold_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L31), &_Type_tasterHold_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 35 },
    /* 36 */ { MAP_LOCAL, "_L32", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L32), &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 36 },
    /* 37 */ { MAP_LOCAL, "_L33", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L33), &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 37 },
    /* 38 */ { MAP_LOCAL, "_L34", NULL, sizeof(zuendSchalter_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L34), &_Type_zuendSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 38 },
    /* 39 */ { MAP_LOCAL, "_L35", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L35), &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 39 },
    /* 40 */ { MAP_LOCAL, "_L36", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, _L36), &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 40 },
    /* 41 */ { MAP_INSTANCE, "simEnv_Pkg::mainPkg::fahrweg 1", NULL, sizeof(outC_fahrweg_simEnv_Pkg_mainPkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, Context_fahrweg_1), NULL, NULL, NULL, &scope_3, 1, 41 },
    /* 42 */ { MAP_INSTANCE, "simEnv_Pkg::mainPkg::fahrzeug 1", NULL, sizeof(outC_fahrzeug_simEnv_Pkg_mainPkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, Context_fahrzeug_1), NULL, NULL, NULL, &scope_11, 1, 42 },
    /* 43 */ { MAP_INSTANCE, "AH_Pkg::main_Pkg::EpbCtrl 1", NULL, sizeof(outC_EpbCtrl_AH_Pkg_main_Pkg), offsetof(outC_fzgIntegration_simEnv_Pkg_mainPkg, Context_EpbCtrl_1), NULL, NULL, NULL, &scope_24, 1, 43 }
};
...
const MappingEntry scope_1_entries[51] = {
    ...
    /* 13 */ { MAP_OUTPUT, "betriebsbremssperrventil", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx.betriebsbremssperrventil, &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L10", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), (size_t)&outputs_ctx._L10, &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L9", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), (size_t)&outputs_ctx._L9, &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L8", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L8, &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L7", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L7, &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L6", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L6, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L5", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L5, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L4", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L4, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L3", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L3, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L2", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L2, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L1", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L1, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L20", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L20, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L21", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L21, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L22", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L22, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L23", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L23, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L24", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L24, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L25", NULL, sizeof(on_off_element_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L25, &_Type_on_off_element_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L26", NULL, sizeof(betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L26, &_Type_betriebsbremsdruck_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L27", NULL, sizeof(epbBremszustand_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L27, &_Type_epbBremszustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L28", NULL, sizeof(v_in_mps_T_AhTypes_Pkg_physical_Pkg), (size_t)&outputs_ctx._L28, &_Type_v_in_mps_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L29", NULL, sizeof(angle_in_rad_T_AhTypes_Pkg_physical_Pkg), (size_t)&outputs_ctx._L29, &_Type_angle_in_rad_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 33 },
    /* 34 */ { MAP_LOCAL, "_L31", NULL, sizeof(t_in_s_T_AhTypes_Pkg_physical_Pkg), (size_t)&outputs_ctx._L31, &_Type_t_in_s_T_AhTypes_Pkg_physical_Pkg_Utils, NULL, NULL, NULL, 1, 34 },
    /* 35 */ { MAP_LOCAL, "_L33", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L33, &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 35 },
    /* 36 */ { MAP_LOCAL, "_L36", NULL, sizeof(epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L36, &_Type_epbBetriebsmodus_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 36 },
    /* 37 */ { MAP_LOCAL, "_L37", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L37, &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 37 },
    /* 38 */ { MAP_LOCAL, "_L45", NULL, sizeof(zuendSchalter_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L45, &_Type_zuendSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 38 },
    /* 39 */ { MAP_LOCAL, "_L44", NULL, sizeof(bremspedalkraft_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L44, &_Type_bremspedalkraft_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 39 },
    /* 40 */ { MAP_LOCAL, "_L43", NULL, sizeof(tasterP_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L43, &_Type_tasterP_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 40 },
    /* 41 */ { MAP_LOCAL, "_L42", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L42, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 41 },
    /* 42 */ { MAP_LOCAL, "_L41", NULL, sizeof(tuerSchalter_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L41, &_Type_tuerSchalter_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 42 },
    /* 43 */ { MAP_LOCAL, "_L40", NULL, sizeof(sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L40, &_Type_sicherheitsgurt_zustand_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 43 },
    /* 44 */ { MAP_LOCAL, "_L39", NULL, sizeof(getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L39, &_Type_getriebeWahlhebel_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 44 },
    /* 45 */ { MAP_LOCAL, "_L38", NULL, sizeof(gaspedalstellung_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L38, &_Type_gaspedalstellung_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 45 },
    /* 46 */ { MAP_LOCAL, "_L46", NULL, sizeof(betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L46, &_Type_betriebsbremsSperrventil_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 46 },
    /* 47 */ { MAP_LOCAL, "_L50", NULL, sizeof(tasterHold_T_AhTypes_Pkg_ah_Pkg), (size_t)&outputs_ctx._L50, &_Type_tasterHold_T_AhTypes_Pkg_ah_Pkg_Utils, NULL, NULL, NULL, 1, 47 },
    /* 48 */ { MAP_INSTANCE, "simEnv_Pkg::mainPkg::fzgIntegration 1", NULL, sizeof(outC_fzgIntegration_simEnv_Pkg_mainPkg), (size_t)&outputs_ctx.Context_fzgIntegration_1, NULL, NULL, NULL, &scope_2, 1, 48 },
    /* 49 */ { MAP_INSTANCE, "AhTypes_Pkg::utils_Pkg::systemUhr 1", NULL, sizeof(outC_systemUhr_AhTypes_Pkg_utils_Pkg), (size_t)&outputs_ctx.Context_systemUhr_1, NULL, NULL, NULL, &scope_80, 1, 49 },
    /* 50 */ { MAP_INSTANCE, "AH_testSuite_Pkg::divFahrer::autoModus_o_autoHold_HillHold 1", NULL, sizeof(outC_autoModus_o_autoHold_HillHold_AH_testSuite_Pkg_divFahrer), (size_t)&outputs_ctx.Context_autoModus_o_autoHold_HillHold_1, NULL, NULL, NULL, &scope_81, 1, 50 }
};
const MappingScope scope_1 = {
    "AH_testSuite_Pkg::tests_Pkg::testAutoModus_o_Autohold_HillHold/ testAutoModus_o_Autohold__AH_testSuite_Pkg_tests_Pkg",
    scope_1_entries, 51
};

const MappingEntry scope_0_entries[1] = {
    /* 0 */ { MAP_ROOT, "AH_testSuite_Pkg::tests_Pkg::testAutoModus_o_Autohold_HillHold", NULL, 0, 0, NULL, NULL, NULL, &scope_1, 1, 0 }
};
