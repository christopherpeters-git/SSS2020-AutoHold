...
#include "testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg.h"

/* AH_testSuite_Pkg::tests_Pkg::testManModus_autoHold/ */
void testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg(
  outC_testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg *outC)
{
  ...
  /* _L37=(AH_testSuite_Pkg::divFahrer::manModus_autoHold#1)/ */
  manModus_autoHold_AH_testSuite_Pkg_divFahrer(
    outC->_L26,
    outC->_L23,
    outC->_L22,
    outC->_L28,
    ...
    outC->_L29,
    outC->_L31,
    &outC->Context_manModus_autoHold_1);
  outC->_L37 = outC->Context_manModus_autoHold_1.gaspedalStellung;
  outC->_L38 = outC->Context_manModus_autoHold_1.getriebeWahlhebel;
  outC->_L39 = outC->Context_manModus_autoHold_1.sicherheitsgurtSchalter;
  outC->_L40 = outC->Context_manModus_autoHold_1.fahrertuerSchalter;
  outC->_L41 = outC->Context_manModus_autoHold_1.error;
  outC->_L42 = outC->Context_manModus_autoHold_1.taste_P;
  outC->_L43 = outC->Context_manModus_autoHold_1.bremspedalKraft;
  outC->_L44 = outC->Context_manModus_autoHold_1.zuendschalter;
  outC->_L45 = outC->Context_manModus_autoHold_1.taste_HOLD;
...
void testManModus_autoHold_init_AH_testSuite_Pkg_tests_Pkg(
  outC_testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg *outC)
{
  outC->_L45 = sw2_off_AhTypes_Pkg_ah_Pkg;
  outC->_L37 = kcg_lit_float64(0.0);
  outC->_L38 = getriebeWahl_P_AhTypes_Pkg_ah_Pkg;
  outC->_L39 = sGurtNichtAngelegt_AhTypes_Pkg_ah_Pkg;
  outC->_L40 = tuerSchalterOffen_AhTypes_Pkg_ah_Pkg;
  outC->_L41 = kcg_true;
  outC->_L42 = tasterP_aus_AhTypes_Pkg_ah_Pkg;
  outC->_L43 = kcg_lit_float64(0.0);
  outC->_L44 = sw2_off_AhTypes_Pkg_ah_Pkg;
  ...
  /* _L37=(AH_testSuite_Pkg::divFahrer::manModus_autoHold#1)/ */
  manModus_autoHold_init_AH_testSuite_Pkg_divFahrer(
    &outC->Context_manModus_autoHold_1);
  /* _L31=(AhTypes_Pkg::utils_Pkg::systemUhr#1)/ */
...
void testManModus_autoHold_reset_AH_testSuite_Pkg_tests_Pkg(
  outC_testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg *outC)
{
  /* _L1=(simEnv_Pkg::mainPkg::fzgIntegration#1)/ */
  fzgIntegration_reset_simEnv_Pkg_mainPkg(&outC->Context_fzgIntegration_1);
  /* _L37=(AH_testSuite_Pkg::divFahrer::manModus_autoHold#1)/ */
  manModus_autoHold_reset_AH_testSuite_Pkg_divFahrer(
    &outC->Context_manModus_autoHold_1);
  /* _L31=(AhTypes_Pkg::utils_Pkg::systemUhr#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
** testManModus_autoHold_AH_testSuite_Pkg_tests_Pkg.c
** Generation date: 2020-05-27T11:32:07
*************************************************************$ */
